/**
 * The original code was sourced from the following CodePen.
 *
 * @link https://codepen.io/vadymhimself/pen/zYGvroM
 */
...
class Canvas {
    constructor() {
        this.config = {
            canvas: document.querySelector('#point-waves-background'),
